...
angular.module('voyager.details').
    factory('detailService', function($http, config, $q, resultsDecorator) {
        ...
        var buildRequest = function(id, displayFields, shard, disp) {
            ...
            var fields = '&fl=id,name:[name],fullpath:[absolute],content:[contentURL],thumb:[thumbURL],preview:[previewURL],download:[downloadURL],bbox,format,hasMetadata,root,tree,tag_tags,links,geo:[geo],hasMissingData,schema,layerURL:[lyrURL]';
